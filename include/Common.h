...
constexpr uint64_t epsilon             = 32;    // 16  NOTE: this affects the cache_efficiency
...
// Synonym leaf
constexpr uint64_t leafNumMax        = 4093750;  // [CONFIG] 1000000 for a/b/c/d; 2000000 for la
