...
constexpr uint64_t modelRegionSize     = 32 * GB;
...
constexpr uint64_t epsilon             = 4;    // 16  NOTE: this affects the cache_efficiency
...
// Synonym leaf
constexpr uint64_t leafNumMax        = 16000000;  // [CONFIG] 1000000 for a/b/c/d; 2000000 for la
