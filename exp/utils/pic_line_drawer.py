...
class LineDrawer(object):
    ...
    def __load_default_style(self):
        ...
        self.lineStyleDict = {
            ...
            'ROLEX'          : (0, ()),
            'HopB-Tree'       : (0, ()),
            'Sherman w/o Leaf Ampl' : (0, ()),
            'Sherman w/o All Ampl'  : (0, ()),
            'KV-grained Lock'       : (0, ()),
            'Node-grained Lock'     : (0, ()),
        ...
        self.lineColorDict = {
            ...
            'ROLEX'          : '#ED1379',
            'HopB-Tree'       : '#002DA5',
            'Sherman w/o Leaf Ampl' : '#311e50',
            'Sherman w/o All Ampl'  : '#D63026',
            'KV-grained Lock'       : '#002DA5',
            'Node-grained Lock'     : '#D63026',
        ...
        self.lineMarkerDict = {
            ...
            'ROLEX'          : 'o',
            'HopB-Tree'       : '+',
            'Sherman w/o Leaf Ampl' : '+',
            'Sherman w/o All Ampl'  : 'o',
            'KV-grained Lock'       : 's',
            'Node-grained Lock'     : 'x',
        ...
        self.zorderDict = {
            ...
            'ROLEX'          : 1300,
            'HopB-Tree'       : 1350,
            'Sherman w/o Leaf Ampl' : 1350,
            'Sherman w/o All Ampl'  : 1300,
            'KV-grained Lock'       : 1350,
            'Node-grained Lock'     : 1300,
