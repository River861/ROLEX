...
def main(cmd: CMDManager, tp: LogParser):
    ...
    plot_data = {
        ...
        'Y_data' : {
            get_legend(method, span_size): {}  # store tpt with various value_sizes, respectively
    ...
    for method, span_size in plot_methods:
        ...
        for value_size in value_sizes:
            ...
            print_GOOD(f"[FINISHED POINT] method={method} span_size={span_size} value_size={value_size} tpt={tpt}")
            plot_data['Y_data'][get_legend(method, span_size)][str(value_size)] = tpt
    # save data
